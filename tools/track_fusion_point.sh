...
# Data and eval
evaluate=0
out_dir="data/track_results/BEVFusion-KF(R)-mul-2-point-nms"
# out_dir="data/track_results/CenterPoint-KF(R)-mul-1-point"
...
python tools/track_fusion_point.py --split $split --workspace $workspace --out-dir $out_dir \
